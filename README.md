...
When a commit to the `master` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/lubianat/ideas_rootstock/tree/gh-pages) and [`output`](https://github.com/lubianat/ideas_rootstock/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://lubianat.github.io/ideas_rootstock/
+ **PDF manuscript** at https://lubianat.github.io/ideas_rootstock/manuscript.pdf
